                ...
                <a href="<?php echo $cartUrl; ?>">
                    <button class="cart">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-cart" aria-hidden="true"
                            ...
                            fill="none">
                            <path d="M14 8.33333H2L7.05263 23H20.9474L26 8.33333H14ZM14 8.33333V1" stroke="currentColor"
                                stroke-width="1.5" stroke-linecap="round" fill="transparent"></path>
                        </svg>
                        <div class="cart-count">
                            <span><?php total_product_cart(); ?></span>
                        </div>
                    </button>
                </a>
            </div>
        </div>
        <div class="search-cart-user-box">
            <div class="search-box slide-box">
                <div class="card">
            ...
            <div class="user-box slide-box">
                ...
                <?php if (!isset($_SESSION["username"])): ?>
                    <div class="card">
                        ...
                        <div class="slide_header">
                            <h4 class="heading">Customer login</h4>
                        ...
                        <div class="body-section">
                            <form action="<?php echo BASE_URL; ?>user_area/login.php" method="post">
                                ...
                                <div class="submit-btn item-btn mb-3">
                                    <button type="submit" value="login" name="user_login" class="speical-btn">
                ...
                <?php else: ?>
                    <div class="welcome_section">
                        <a href="#">
                            <h4 class="heading">Welcome, <?php echo $_SESSION["username"]; ?></h4>
                        </a>
                        <ul class="">
                            <li><a
            ...
            <div class="row gy-4">
                <div class="col-lg-4">
                    <div class="footer-about footer-box">
                        ...
                        <p>GameBox is your one-stop destination for the latest and greatest in video gaming. We offer a curated selection of top games, consoles, and accessories, making it easy for gamers of all levels to find what they love. Our mission is to deliver an exceptional shopping experience, expert recommendations, and a vibrant community for every gaming enthusiast. Level up your collection with GameBox!</p>
                    </div>
                </div>
                <div class="col-8">
                        ...
                        <div class="col-4">
                            <div class="footer-box">
                                ...
                                <ul class="list-none">
                                    ...
                                    <li><a href="termsandcondition.php" title>Terms &amp; Conditions</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="footer-box">
                                ...
                                <ul class="list-none">
                                    ...
                                    <li><a href="tel:+977 9876543210">+977 9861744430</a></li>
                                    <li><a href="mailto: gamerbox@gmail.com" title>gamerbox@gmail.com</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
